...
const reviewRoutes_1 = require("../modules/appReview/reviewRoutes");
const helpCenter_routes_1 = require("../modules/admin/help-center/helpCenter.routes");
const tips_routes_1 = require("../modules/admin/personelTips/tips.routes");
const stories_routes_1 = require("../modules/admin/successsStories/stories.routes");
...
const moduleRoutes = [
    ...
    {
        path: '/app-review',
        route: reviewRoutes_1.appReviewRouter,
    },
    { path: '/admin/help-center', route: helpCenter_routes_1.helpCenterRouter },
    { path: '/admin/online-personal-tips', route: tips_routes_1.onlinePersonalTipRouter },
    {
        path: "/admin/counter",
        route: counter_routes_1.counterRouter
    },
    {
        ...
        route: helpCenter_routes_1.helpCenterRouter
    },
    {
        path: '/success-stories',
        route: stories_routes_1.successStoryRouter,
    },
];
