...
exports.fraudAlertRouter = void 0;
const express_1 = require("express");
const fraudAlert_controller_1 = require("./fraudAlert.controller");
 ...
 */
router.post("/", authMiddleware_1.authenticate, fraudAlert_controller_1.createOrUpdateFraudAlert);
/**
 * @swagger
 * /v1/api/admin/fraud-alert:
 *   get:
 ...
 */
router.get("/", fraudAlert_controller_1.getFraudAlert);
exports.fraudAlertRouter = router;
