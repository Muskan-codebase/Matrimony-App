...
exports.qualificationRouter = void 0;
const express_1 = require("express");
const qualification_controllers_1 = require("./qualification.controllers");
 ...
 */
router.post("/", authMiddleware_1.authenticate, qualification_controllers_1.createQualification);
/**
 * @swagger
 * /v1/api/admin/qualification:
 *   get:
 ...
 *         description: Unauthorized.
 */
router.get("/", qualification_controllers_1.getQualifications);
/**
 * @swagger
 ...
 */
router.get("/:id", qualification_controllers_1.getQualificationById);
/**
 * @swagger
 * /v1/api/admin/qualification/{id}:
 *   put:
 ...
 *         description: Qualification not found.
 */
router.put("/:id", authMiddleware_1.authenticate, qualification_controllers_1.updateQualification);
/**
 * @swagger
 * /v1/api/admin/qualification/{id}:
 *   patch:
 ...
 *         description: Qualification not found.
 */
router.patch("/:id", authMiddleware_1.authenticate, qualification_controllers_1.deleteQualification);
exports.qualificationRouter = router;
