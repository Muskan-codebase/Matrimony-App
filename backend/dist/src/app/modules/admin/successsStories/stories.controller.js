...
const createSuccessStory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const validatedData = stories_validation_1.createSuccessStorySchema.parse(Object.assign(Object.assign({}, req.body), { year: Number(req.body.year), isActive: req.body.isActive !== undefined
                ? req.body.isActive === 'true'
                : undefined, image: (_a = req.file) === null || _a === void 0 ? void 0 : _a.path }));
        const successStory = yield stories_model_1.SuccessStory.create(validatedData);
        res.status(201).json({
            success: true,
...
const getSuccessStories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const total = yield stories_model_1.SuccessStory.countDocuments(filter);
        const successStories = yield stories_model_1.SuccessStory.find(filter)
            .sort({ createdAt: -1 })
            .skip(skip)
            .limit(limit);
        res.status(200).json({
...
const getSuccessStoryById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const successStory = yield stories_model_1.SuccessStory.findOne({
            _id: req.params.id,
            isDeleted: false,
        });
        if (!successStory) {
...
const updateSuccessStory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingStory = yield stories_model_1.SuccessStory.findOne({
            _id: req.params.id,
            isDeleted: false,
        });
        if (!existingStory) {
        ...
        const validatedData = stories_validation_1.updateSuccessStorySchema.parse(Object.assign(Object.assign(Object.assign(Object.assign({}, req.body), (req.body.year && { year: Number(req.body.year) })), (req.body.isActive !== undefined && {
