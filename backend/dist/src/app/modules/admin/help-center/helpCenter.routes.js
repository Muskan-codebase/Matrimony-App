 ...
 */
router.post('/', authMiddleware_1.authenticate, cloudinary_1.upload.single('icon'), helpCenter_controllers_1.createHelpCenter);
/**
 * @swagger
 * /v1/api/admin/help-center:
 *   get:
 ...
 *         description: Unauthorized
 */
router.put('/:id', authMiddleware_1.authenticate, cloudinary_1.upload.single('icon'), helpCenter_controllers_1.updateHelpCentre);
/**
 * @swagger
 * /v1/api/admin/help-center/{id}:
 *   delete:
