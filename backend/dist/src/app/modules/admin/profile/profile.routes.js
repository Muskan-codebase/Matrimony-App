...
exports.adminProfileRouter = void 0;
 ...
 */
router.post("/", authMiddleware_1.authenticate, cloudinary_1.upload.array("photos", 6), profile_controller_1.addProfile);
/**
 * @swagger
 ...
 */
router.put("/:id", authMiddleware_1.authenticate, cloudinary_1.upload.array("photos", 6), profile_controller_1.updateProfile);
/**
 * @swagger
 * /v1/api/admin/profile:
 *   get:
 ...
 */
router.get("/:id", authMiddleware_1.authenticate, profile_controller_1.getProfileById);
/**
 * @swagger
 * /v1/api/admin/profile/{id}:
 *   delete:
 ...
 */
router.delete("/:id", authMiddleware_1.authenticate, profile_controller_1.deleteProfile);
exports.adminProfileRouter = router;
