...
const contactUs_controllers_1 = require("./contactUs.controllers");
 ...
 */
router.post("/", authMiddleware_1.authenticate, contactUs_controllers_1.createOrUpdateContactUs);
/**
 * @swagger
 * /v1/api/contact-us:
 *   get:
 ...
 */
router.get("/", contactUs_controllers_1.getContactUs);
