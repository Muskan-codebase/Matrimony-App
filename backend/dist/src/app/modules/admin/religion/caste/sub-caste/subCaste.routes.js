...
exports.subCasteRouter = void 0;
const express_1 = require("express");
const subCaste_controllers_1 = require("./subCaste.controllers");
 ...
 */
router.post("/", authMiddleware_1.authenticate, subCaste_controllers_1.createSubCaste);
/**
 * @swagger
 * /v1/api/admin/sub-caste:
 *   get:
 ...
 */
router.get("/", subCaste_controllers_1.getSubCastes);
/**
 * @swagger
 ...
 */
router.get("/caste/:casteId", subCaste_controllers_1.getSubCastesByCaste);
/**
 * @swagger
 ...
 */
router.get("/:id", subCaste_controllers_1.getSubCasteById);
/**
 * @swagger
 * /v1/api/admin/sub-caste/{id}:
 *   put:
 ...
 *         description: Sub-caste already exists.
 */
router.put("/:id", authMiddleware_1.authenticate, subCaste_controllers_1.updateSubCaste);
/**
 * @swagger
 * /v1/api/admin/sub-caste/{id}:
 *   patch:
 ...
 *         description: Sub-caste not found.
 */
router.patch("/:id", authMiddleware_1.authenticate, subCaste_controllers_1.deleteSubCaste);
exports.subCasteRouter = router;
