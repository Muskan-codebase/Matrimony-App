...
exports.profileVisitsRouter = void 0;
const express_1 = __importDefault(require("express"));
const profileVisits_controllers_1 = require("./profileVisits.controllers");
 ...
 */
router.post("/", authMiddleware_1.authenticate, profileVisits_controllers_1.createProfileVisit);
/**
 * @swagger
 ...
 *         description: Profile not found.
 */
router.get("/visited", authMiddleware_1.authenticate, profileVisits_controllers_1.getMyVisitedProfiles);
/**
 * @swagger
 ...
 *         description: Profile not found.
 */
router.get("/visitors", authMiddleware_1.authenticate, profileVisits_controllers_1.getProfileVisitors);
// /**
//  * @swagger
...
exports.profileVisitsRouter = router;
