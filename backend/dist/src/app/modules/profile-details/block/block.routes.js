 ...
 */
router.post("/", authMiddleware_1.authenticate, block_controllers_1.blockProfile);
/**
 * @swagger
 * /v1/api/block:
 *   get:
 ...
 *         description: Internal server error.
 */
router.get("/", authMiddleware_1.authenticate, block_controllers_1.getMyBlockedProfiles);
/**
 * @swagger
 * /v1/api/block/{id}:
 *   get:
 ...
 *         description: Internal server error.
 */
router.get("/:id", authMiddleware_1.authenticate, block_controllers_1.getBlockedProfileById);
/**
 * @swagger
 * /v1/api/block/{id}:
 *   delete:
 ...
 *         description: Internal server error.
 */
router.delete("/:id", authMiddleware_1.authenticate, block_controllers_1.unblockProfile);
