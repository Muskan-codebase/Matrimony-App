 ...
 */
router.get('/blocked', authMiddleware_1.authenticate, reportProfile_controllers_1.getBlockedProfiles);
...
router.patch('/unblock/:profileId', authMiddleware_1.authenticate, reportProfile_controllers_1.unblockProfile);
