...
exports.getBlockedProfiles = exports.dismissProfileReport = exports.unblockProfile = exports.blockReportedProfile = exports.getProfileReportById = exports.getProfileReports = exports.reportProfile = void 0;
...
const reportProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if ((reporterProfileId === null || reporterProfileId === void 0 ? void 0 : reporterProfileId.toString()) === reportedProfileId.toString()) {
            return res.status(400).json({
                success: false,
...
const unblockProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield profile_model_1.Profile.findByIdAndUpdate(profileId, {
            $set: {
                isBlocked: false,
                blockedAt: null,
                blockedBy: null,
...
const getBlockedProfiles = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const blockedReports = yield reportProfile_model_1.ProfileReport.find({
            status: reportProfile_interface_1.ReportStatus.RESOLVED,
            adminAction: 'blocked',
        })
            .populate('reportedProfileId', 'basicDetails.firstName basicDetails.lastName matrimonyId profilePhoto isBlocked')
            .populate('adminId', 'name email')
