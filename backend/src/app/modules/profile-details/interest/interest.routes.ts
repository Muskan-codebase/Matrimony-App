 ...
 */
router.post("/", authenticate, sendInterest);
/**
 * @swagger
 ...
 */
router.get("/sent", authenticate, getSentInterests);
/**
 * @swagger
 ...
 */
router.patch("/:id/accept", authenticate, acceptInterest);
/**
 * @swagger
 ...
 *         description: Interest not found.
 */
router.patch("/:id/reject", authenticate, rejectInterest);
/**
 * @swagger
 ...
 *         description: Interest not found.
 */
router.patch("/:id/withdraw", authenticate, withdrawInterest);
