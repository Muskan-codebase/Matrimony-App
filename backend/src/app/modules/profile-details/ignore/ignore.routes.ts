 ...
 */
router.post("/", authenticate, addToIgnore);
/**
 * @swagger
 * /v1/api/ignore:
 *   get:
 ...
 *         description: Internal server error.
 */
router.get("/", authenticate, getMyIgnoredProfiles);
/**
 * @swagger
 * /v1/api/ignore/{id}:
 *   get:
 ...
 *         description: Internal server error.
 */
router.get("/:id", authenticate, getIgnoreById);
/**
 * @swagger
 * /v1/api/ignore/{id}:
 *   delete:
 ...
 *         description: Internal server error.
 */
router.delete("/:id", authenticate, removeFromIgnore);
